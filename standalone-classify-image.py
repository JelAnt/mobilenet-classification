...
categories = os.listdir(
    "C:/Users/marko/Desktop/computer vision project/garbage_classification_dataset_model/validate"
...
resultText = classify_image(
    imagePath
)  # run the classification function on this test image
print(resultText)  # prints the result


img = cv2.imread(imagePath)  # creates a windows to display the image
img = cv2.putText(
    img, resultText, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2, cv2.LINE_AA
)  # puts the result text on the image window
